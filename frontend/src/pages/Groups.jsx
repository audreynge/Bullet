...
// group context here later
// group_users table with group_id and user_id
...
export default function Groups() {
  ...
  return (
    <div className="pt-[100px] p-14 max-w-md">
      {showGroupInvite && <GroupInvite setShowGroupInvite={setShowGroupInvite} />}
      ...
      <section>
        ...
        <button
          ...
          onClick={() => setShowGroupInvite(!showGroupInvite)}
        >
          <span
            aria-hidden="true"
